      ...
      <div className="q-up">
        <div className="q-up-content">
          ...
          <div className="q-span">
            <span className="span-one">It is a log established fact that a reader will be distracted by the readable</span>
...
<div className="set-green">
  ...
  >
  <option selected>Do you offer refunds for unused subscription periods ?</option>
  <option value="1">One</option>
  <option value="2">Two</option>
  <option value="3">Three</option>
</select>
  ...
  <div class="shadow-sm p-3 mb-5 bg-body-tertiary rounded">
    ...
    <span>Once you have subscribed,there is no refund option. You can cancel your subscription to prevent</span> <br />
