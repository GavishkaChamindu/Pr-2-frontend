...
import { GrFacebookOption, GrGooglePlus, GrInstagram, GrTwitter, GrYoutube } from "react-icons/gr";
            ...
            <div className="f-col">
               <div className="footer-col-right-contains">
                ...
                <div className="f-r-c-title">
                    <span className="right-title-span">Try our generator of</span><br />
                    <span className="right-title-span">QR codes for 7 days</span> <br />
